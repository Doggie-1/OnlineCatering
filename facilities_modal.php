	  ...
	  <div class="modal-content">
        <div class="modal-header">
         ...
         <div class="modal-body">
                <div class="padd">
					<p> 1. Catering is within the area of Cagayan de Oro City only.</p>

					<p> 2. MINIMUM Pax For Lunch nd Dinner 50px , Merienda 100px and in the Non-Combo Combo meal is 30px.</p>
					...
					<p> 7. Terms of payments will be via Gcash, bank to bank, cash.
close</p>
				</div>
        </div>
